...
| Hosting | Ninguno por ahora (solo local) | El usuario decidió no desplegar todavía; el requisito es que la carpeta sea deployable tal cual (solo abrir index.html) cuando decida subirla. |
